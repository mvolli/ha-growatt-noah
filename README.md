...
**Note**: The Noah 2000 API doesn't provide daily energy totals directly, so the integration sensors (created from power sensors) are the recommended approach for the energy dashboard.
